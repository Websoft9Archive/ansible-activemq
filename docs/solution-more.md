...
The precondition for **Domain binding** is have completed the **Domain resolution** for ActiveMQ Instance.

From the perspective of server security and subsequent maintenance considerations, the **Domain Binding** step cannot be omitted.

ActiveMQ domain name binding steps:
...
ActiveMQ CLI is a command tool for ActiveMQ management, configuration and upgrade. Connect ActiveMQ server with SSH and run the command `odoo -h` to list all usage command of ActiveMQ below:
...
Options:
  ...
  Common options:
    ...
    -D DATA_DIR, --data-dir=DATA_DIR
                        Directory where to store ActiveMQ data
  ...
  Internationalisation options. :
    Use these options to translate ActiveMQ to another language. See i18n
...
More detail about ActiveMQ CLI, refer to ActiveMQ official docs: [Command-line interface: odoo-bin](https://www.odoo.com/documentation/13.0/reference/cmdline.html)
